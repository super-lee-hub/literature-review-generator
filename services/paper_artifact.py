    ...
    *,
    ...
    return PaperArtifactV1(
        ...
        stage1_inputs={
            ...
            "stage1_quality_reasons": list(preprocess.get("stage1_quality_reasons") or []),
            "selected_text_length": int(preprocess.get("selected_text_length") or 0),
            "page_count": int(preprocess.get("stage1_page_count") or 0),
            "completeness_metrics": dict(preprocess.get("stage1_completeness_metrics") or {}),
