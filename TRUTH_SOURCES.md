...
- **Primary Truth Source**: `*_literature_review_outline.md` generated by `Outline_API`
- **Fallback**: `Writer_API` if `Outline_API` is not configured
- **Key Artifacts**:
  - `*_literature_review_outline.md` (with `generator_model` set to actual `Outline_API` model)
