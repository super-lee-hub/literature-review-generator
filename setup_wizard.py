...
DEFAULT_MINERU_ENV_VALUES: Dict[str, str] = {
    ...
    "MINERU_UPLOAD_TIMEOUT_SECONDS": "120",
    "MINERU_DOWNLOAD_TIMEOUT_SECONDS": "120",
    "MINERU_REQUEST_MAX_RETRIES": "2",
    "MINERU_RETRY_BACKOFF_SECONDS": "1.5",
    "MINERU_MAX_REMOTE_TASKS": "50",
    "MINERU_MAX_REMOTE_HTTP_CALLS": "500",
    "MINERU_MAX_REMOTE_UPLOAD_BYTES": str(2 * 1024 * 1024 * 1024),
    "MINERU_RESPONSE_MAX_BYTES": str(64 * 1024 * 1024),
    "MINERU_ZIP_MAX_ENTRIES": "4096",
    "MINERU_ZIP_MAX_UNCOMPRESSED_BYTES": str(256 * 1024 * 1024),
    "MINERU_ZIP_MAX_ENTRY_BYTES": str(64 * 1024 * 1024),
    "MINERU_ZIP_MAX_COMPRESSION_RATIO": "200",
    "MINERU_JSON_MAX_BYTES": str(32 * 1024 * 1024),
    "MINERU_TEXT_MAX_BYTES": str(64 * 1024 * 1024),
    "MINERU_SOURCE_PDF_MAX_BYTES": str(128 * 1024 * 1024),
