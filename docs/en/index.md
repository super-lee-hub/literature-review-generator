...
|---------|----------|---------|
| [developer/](./developer/index.md) | Developers, contributors | Architecture overview, module map, dev environment setup, testing, contribution workflow, technical constraints |
| [ai/](./ai/index.md) | AI agents, Codex/OMX users | AI handoff, Codex/OMX skill docs, AI-native runtime bridge, operating rules |
| [runtime/](./runtime/index.md) | Maintainers, AI agents | Truth sources, artifact lifecycle, compatibility paths, job workspace, validation/repair chain |
| [reference/](./reference/index.md) | Everyone | CLI flags, config fields, artifact glossary, feature matrix, migration history |
