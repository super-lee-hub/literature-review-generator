...
- `validate` performs a read-only closure check over the current v3 review draft, v3 citation manifest, and `ValidationRunResultV1`, including Registry identity and hash equality.
