...
| 分区 | 受众 | 内容 |
|------|------|------|
| [developer/](./developer/index.md) | 开发者、贡献者 | 架构概览、模块地图、开发环境搭建、测试、贡献流程、技术约束 |
| [ai/](./ai/index.md) | AI Agent、Codex/OMX 用户 | AI 交接文档、Codex/OMX Skill 说明、AI 运行时桥接、操作规则 |
| [runtime/](./runtime/index.md) | 维护者、AI Agent | 真源体系、产物生命周期、兼容性路径、工作区结构、验证/修复链 |
| [reference/](./reference/index.md) | 所有人 | CLI 参数、配置字段、产物词汇表、功能矩阵、迁移历史 |
