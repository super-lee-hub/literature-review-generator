...
| `stage1.visual_scan.system.v1` | `prompts/active/stage1/system_visual_scan_v1.txt` | `stage1_visual_scan.build_visual_scan_prompt` | ACTIVE | 无 | `stage1_visual_observations/v1` JSON | v1 | visual scan call identity 和 observation artifact 输入 |
